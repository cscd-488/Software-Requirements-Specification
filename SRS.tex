...
The product being outlined in this System Requirements Document is an event navigator that allows a user to link up to an event to track which event locations that they had gone to. Visiting locations and checking n will allow the user to collect ’badges’ and hopefully, with the support of the local community, be able to 'redeem' them at local establishments

\section{Document Conventions}
Not applicable at this time

\section{Intended Audience and Reading Suggestions}
This document is put together for companies planning to use this product for their events as well as future developers planning to contribute and continue this project.
...
This product allows for users to link into an event or events they are attending to get information on locations to visit while at the event. Eventually, the application would take clients and allow them to push event information to the application's server. It would be the event coordinator to get community rewards for attendance and ’badges’.
...
\subsection{Stimulus/Response Sequences}
User will open app. Asynchronous task will run in the background, updating the device's
